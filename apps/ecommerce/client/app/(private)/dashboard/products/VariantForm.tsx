      ...
      {fields.map((field, index) => (
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {[
              ["variantType", "Variant / starter type", "DOL, star-delta"],
              ["boxType", "Box type", "Metal / plastic"],
              ["bodyType", "Body type", "Panel body"],
              ["meterType", "Meter type", "Voltmeter / ammeter"],
              ["meterSize", "Meter size", "96 x 96 mm"],
              ["startCapacitor", "Start capacitor", "e.g. 100-120 mfd"],
              ["runCapacitor", "Run capacitor", "e.g. 36 mfd"],
              ["mcbRelayOlp", "MCB / Relay / OLP", "Relay / OLP details"],
