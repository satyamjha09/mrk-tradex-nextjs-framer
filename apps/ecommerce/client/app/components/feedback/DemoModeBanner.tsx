      ...
      <div className="mx-auto flex max-w-7xl flex-col items-start gap-3 px-4 py-3 sm:flex-row sm:items-center sm:px-6 lg:px-8">
        ...
        <div className="w-full min-w-0 flex-1 text-sm leading-snug text-amber-950 sm:w-auto">
          <p>
            ...
            {" - "}
            no live API or database. Catalog browsing, enquiries, dealer flow,
            downloads, site settings, and admin dashboards run entirely in your
            browser.
          </p>
          <p className="mt-1 text-amber-900/85">
            Cart, checkout, payments, customer orders, reviews, and chat are
            disabled for the MRK catalog build. Changes persist in local storage
