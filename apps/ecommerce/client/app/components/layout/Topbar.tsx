...
const Topbar = ({
  ...
  const fallbackConfig = {
    shopLink: "/products",
    shopText: "View Catalog",
    dispatchText: "Technical catalog and product enquiries",
    giftCardText: "Dealer applications are open",
    shippingText: "Manuals and price lists available",
  };
  ...
  const announcements = [
    ...
    { icon: <MapPinned size={16} />, text: giftCardText },
    { icon: <Download size={16} />, text: shippingText },
  ];
