    ...
    return (
      <MainLayout>
        <div className="flex min-h-[70vh] items-center justify-center px-4 py-16">
          <div className="max-w-md rounded-sm border border-gray-200 bg-white p-6 text-center shadow-sm">
            <Shield className="mx-auto mb-4 h-10 w-10 text-indigo-600" />
            <h1 className="text-2xl font-semibold text-gray-900">
              Customer profiles are disabled
            </h1>
            <p className="mt-3 text-sm leading-6 text-gray-600">
              MRK is currently configured as a public catalog and enquiry site.
              Admin users can continue to manage catalog and leads from the
              dashboard.
            </p>
