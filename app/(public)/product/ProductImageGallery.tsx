...
const ProductImageGallery: React.FC<ProductImageGalleryProps> = ({
  ...
  if (displayImages.length === 0) {
    return (
      <div className="relative flex h-[300px] items-center justify-center rounded-2xl bg-gray-50 p-3 sm:h-[420px] sm:p-5 lg:h-[500px] lg:p-6">
        <Image
          src={HeroImage}
          alt={name}
          fill
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex ${
          isFullScreen ? "h-full" : ""
        } flex-col gap-4 md:flex-row md:gap-6`}
      >
        {/* Thumbnails */}
        <div
        ...
        >
          {displayImages.map((img, index) => (
            <button
              ...
              className={`relative shrink-0 border-2 rounded-xl p-1 transition-all duration-200 ${
                selectedImage === img
        ...
        >
          ...
          <div
            className={`flex items-center justify-center ${
              isFullScreen ? "h-full" : "rounded-2xl bg-gray-50 p-3 sm:p-5 lg:p-6"
            } overflow-hidden`}
            ...
            <div
              className={`relative ${
                isFullScreen
                  ...
                  : "h-[300px] w-full sm:h-[420px] lg:h-[500px]"
