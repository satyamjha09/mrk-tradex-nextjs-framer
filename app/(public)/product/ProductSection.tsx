  ...
  return (
    <section className="bg-white py-8 sm:py-10 lg:py-14">
      <div className="mx-auto max-w-[1760px] px-4 sm:px-8 lg:px-12 xl:px-16">
        {showTitle && (
          ...
          >
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <h2 className="text-2xl font-black tracking-normal text-black sm:text-3xl lg:text-4xl">
                {shouldHighlight ? (
                  <>
        ...
        <div className="-mx-4 flex snap-x gap-5 overflow-x-auto px-4 pb-8 [scrollbar-width:none] sm:-mx-8 sm:gap-6 sm:px-8 lg:-mx-12 lg:px-12 xl:-mx-16 xl:px-16 [&::-webkit-scrollbar]:hidden">
          {products.map((product, index) => (
            <div
              key={product.id}
              className="min-w-[min(86vw,300px)] snap-start sm:min-w-[330px] lg:min-w-[340px] xl:min-w-[354px]"
            >
