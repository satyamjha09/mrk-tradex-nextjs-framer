...
const popularCategories = [
  { name: "Single Phase Starters", href: "/shop?phase=SINGLE_PHASE" },
  { name: "Three Phase Panels", href: "/shop?phase=THREE_PHASE" },
  { name: "Smart Controls", href: "/shop?search=smart" },
  { name: "Cables & Accessories", href: "/shop?search=cable" },
];
